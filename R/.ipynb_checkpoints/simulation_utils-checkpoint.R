...
#' @export
burn_phase <- function(model, sim, params, verbose) {
    sim_system <- model$simulation_system
    ...
    if (verbose) message("Burn Phase of Simulation...")
...
#' @export
perturb_phase <- function(model, sim, params, verbose) {
    sim_system <- model$simulation_system
    ...
    if (verbose) message("Perturb Phase of Simulation...")
...
#' @export
sampling_phase <- function(model, sim, params, verbose) {
    sim_system <- model$simulation_system
    ...
    if (verbose) message("Sampling Phase of Simulation...")
